...
A Constituição assegura direitos fundamentais a todos os brasileiros e estrangeiros residentes no país, mas não se estende a entidades que não se enquadrem na noção de "pessoa" (física ou jurídica) protegida pelo ordenamento jurídico.

...
Code: For short snippets use SINGLE BACK QUOTES(e.g., "Which operator in Python checks for identity? Answer: `is`"). NEVER PUT EXTENSIVE CODE.

DON'T USE ANY KIND OF SEPARATION FOR THE CARDS OTHER THAN THE BLANK SPACE, SO DON'T USE FOR EXAMPLE ___ or *** or --- etc
...
ALWAYS SEND YOUR RESPONSE IN MARKDOWN (START YOUR RESPONSE WITH TRIPLE BACKQUOTES AND THEN END THE RESPONSE WITH ANOTHER TRIPLE BACKQUOTES, DON'T EVER, IN ANY CONDITION, NO MATTER WHAT, USE THE TRIPLE BACKQUOTES FOR ANY OTHER PURPOSE)
